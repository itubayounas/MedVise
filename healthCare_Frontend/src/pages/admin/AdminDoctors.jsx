...
import { getPendingDoctors, approveDoctor, rejectDoctor  } from "../../api";
      ...
      <div className="animate-fade-up">
        <h1 className="page-title">
          <i
            ...
            style={{ color: "var(--color-sage-500)", marginRight: "0.5rem" }}
          ></i>
          Doctor Approvals
        </h1>
        ...
        >
          <i
            ...
            style={{ color: "#2563eb", marginTop: "0.1rem", flexShrink: 0 }}
          ></i>
          <p
            style={{ fontSize: "0.875rem", color: "#1d4ed8", lineHeight: 1.5 }}
          >
            Doctors cannot log in until approved. Review their specialty,
            experience, and fee carefully before approving.
          </p>
        </div>
              ...
              >
                ...
                >
                  ...
                  <div style={{ flex: 1, minWidth: 0 }}>
                    ...
                    >
                      {d.specialty || "No specialty listed"}
                    </p>
                    <span
                ...
                >
                  ...
                  {d.price != null && (
                    <p className="info-row">
                      <i className="fa-solid fa-dollar-sign"></i>${d.price} per
                      appointment
                    </p>
                  )}
                  {d.address && (
                ...
                <div style={{ display: "flex", gap: "0.5rem" }}>
                  ...
                  >
                    {approving === d._id ? "Approving..." : "Approve"}
                  </button>

                  <button
                    onClick={() => handleReject(d._id)}
                    className="btn-base btn-danger btn-full"
